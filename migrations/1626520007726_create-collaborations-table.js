...
exports.up = (pgm) => {
  ...
  // constraint foreign key pada kolom playlist_id dan user_id terhadap playlists.id dan users.id
  ...
  pgm.addConstraint('collaborations', 'uniq_playlist_id_and_user_id', 'UNIQUE(playlist_id, user_id)');
};
